#https://medium.com/@khandanial114/from-code-to-combat-space-invaders-game-tutorial-using-python-and-pygame-164526801881
#https://github.com/Dankhan11/space-invaders/blob/main/space_invaders.py
import pygame
import random
import sys
import time
